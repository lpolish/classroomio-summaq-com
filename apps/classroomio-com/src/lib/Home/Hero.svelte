...
<div class="bg-[url('https://assets.cdn.clsrio.com/www/hero-bg.svg')] dark:bg-[url('/hero-bg-dark.svg')] relative border-b-2 border-gray-200 dark:border-gray-700 text-center bg-[#F5F8FE] dark:bg-gray-900 text-gray-900 dark:text-gray-100 h-full mt-[5%] w-full">
